            ...
            <div className="absolute inset-0 flex flex-col lg:flex-row z-0">
                ...
                <div className="w-full lg:w-1/2 h-full relative overflow-hidden bg-gray-200">
                    ...
                    <img
                        ...
                        className="absolute inset-0 w-full h-full object-cover transform scale-100 group-hover/section:scale-105 transition-transform duration-[2.5s] ease-out"
                    />
                </div>
            </div>
            ...
            <div className="relative z-10 w-full max-w-[1440px] mx-auto flex flex-col flex-grow">
                <div className="flex flex-col lg:flex-row w-full flex-grow">
                    ...
                    <div className="w-full lg:w-1/2 flex flex-col bg-[#f4f9fd] lg:bg-transparent">
                        ...
                        {/* Upper Content Area */}
                        <div className="px-6 py-16 sm:px-12 md:px-16 lg:pl-20 xl:pl-28 lg:pr-10 lg:pt-32 xl:pt-40 flex-grow">
                            {/* Badge */}
                            <div className="inline-flex items-center bg-[#FFC107] text-[#111] font-bold uppercase tracking-[0.2em] text-[10px] sm:text-xs px-4 py-2 mb-8 shadow-sm">
                                <span className="mr-2">//</span> LET'S WORK TOGETHER
                            </div>

                            {/* Heading */}
                            <h2 className="text-[2.5rem] sm:text-[3.5rem] lg:text-[4rem] xl:text-[4.8rem] font-black text-[#111] leading-[0.95] mb-8 tracking-tighter uppercase font-heading italic lg:not-italic">
                                Connect with <br />
                                our team today
                            </h2>

                            <p className="text-gray-600 font-medium text-base sm:text-lg leading-relaxed mb-10 max-w-md">
                                Contact our team today for reliable support, clear communication, and professional assistance with your construction needs.
                            </p>

                            {/* Action Link */}
                            <button className="flex items-center group cursor-pointer appearance-none bg-transparent border-none p-0">
                        ...
                        <div className="flex flex-col sm:flex-row w-full mt-auto">
                            {/* Phone Box */}
